if (window.jQuery) {
    $(document).ready(function() {
        ...
        .forEach(function (el) {
            $(document).on('click', el, function(event) {
                ...
                if (cal.length && list.length) {
                    ...
                    $.getJSON('/events/month/shift/' + qs, data, calSuccess);
                } else if (list.length) {
        ...
        function init_calendar_events() {
            $(".event-anch").click(function(event) {
                event.preventDefault();

                $("#event_title").html($(this).find(".event_title").html());
                $("#event_date").html($(this).find(".event_date").html());
                $("#event_description").html($(this).find(".event_description").html());
